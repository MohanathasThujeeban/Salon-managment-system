...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> saveEmployee(
            @RequestParam String empFirstName,
            @RequestParam String empLastName,
            @RequestParam String empIc,
            @RequestParam String empEmail,
            @RequestParam String empAddress,
            @RequestParam String empGender,
            @RequestParam String empPhone,
            @RequestParam String empJoiningDate,
            @RequestParam String empDateOfBirth,
            @RequestParam MultipartFile empProfilePhoto,
             @RequestParam String empService
             ){
